...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e3=(EditText) findViewById(R.id.house);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String gethouse=e3.getText().toString();
                ...
                Toast.makeText(getApplicationContext(),getuname+" "+getage+" "+gethouse+" "+getpin+" "+getmob+" "+getuser+" "+getpswrd+" "+getconfirm,Toast.LENGTH_LONG).show();
